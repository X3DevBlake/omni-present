...
const hubs = [
  ...
  { id: 2, label: 'Features', page: 'Features', icon: '✨', color: '#a855f7' },
  { id: 3, label: 'AI Playground', page: 'AIPlayground', icon: '🎨', color: '#10b981' },
  { id: 4, label: 'Architecture', page: 'Architecture', icon: '🏗️', color: '#f59e0b' },
  { id: 5, label: 'Blueprint', page: 'Blueprint', icon: '📐', color: '#ec4899' },
  { id: 10, label: 'AI Lab', page: 'AILab', icon: '🧪', color: '#a855f7' },
  { id: 6, label: 'World', page: 'World', icon: '🌍', color: '#06b6d4' },
  { id: 7, label: 'Omni Hub', page: 'OmniHub', icon: '💰', color: '#8b5cf6' },
  { id: 8, label: 'Simulations', page: 'AdvancedSimulation', icon: '🎮', color: '#ec4899' },
  { id: 9, label: 'Profile', page: 'ProfileHome', icon: '👤', color: '#06b6d4' },
];
