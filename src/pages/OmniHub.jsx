...
import OmniCoin3DHero from '../components/omni/OmniCoin3DHero';
import Enhanced3DCard from '../components/omni/Enhanced3DCard';
      ...
      <AuroraBackground className="min-h-screen">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link key={i} to={createPageUrl(item.page)}>
            <Enhanced3DCard item={item} delay={i * 0.05} />
          </Link>
          ))}
          </div>
          </div>
